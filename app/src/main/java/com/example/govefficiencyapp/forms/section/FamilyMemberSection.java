...
public class FamilyMemberSection extends Fragment {
    public FamilyMemberSection() {
        super(R.layout.section_family_member); // Use your layout resource
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.section_family_member, container, false);
    }
